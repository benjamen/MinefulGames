...
export class GameSetup {
     ...
     */
    startGame(players, arenaOffset, arenaLowerCorner, // renamed for clarity
    arenaSize) {
    ...
    endGame(players) {
        ...
        players.forEach((player) => {
            ...
            player.teleport({ x: 20, y: -60, z: -6 }, { dimension: world.getDimension(MinecraftDimensionTypes.overworld) });
    ...
    resetPlayerScores(players) {
        ...
        players.forEach((player) => {
            try {
                ...
                console.error(`❌ Failed to reset score for player ${(player === null || player === void 0 ? void 0 : player.name) || "unknown"}:`, error);
            }
        });
    }
}
