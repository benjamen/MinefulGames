...
const AvoidUnnecessaryCommand_js_1 = __importDefault(require("./AvoidUnnecessaryCommand.js"));
...
ruleTester.run('avoid-unnecessary-command', AvoidUnnecessaryCommand_js_1.default, {
    valid: [
        {
